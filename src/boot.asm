...
boot:
  ...
  mov [BOOT_DISK], dl
     ...
     welcome_msg  db "", 0Dh,0Ah ; main message
	 db "Welcome to KolarOS Coralriff", 0Dh,0Ah
	  db "", 0Dh,0Ah
     db "Version Alpha 0.0.26 - Build 21052023", 0Dh,0Ah
	 ...
	 db "Just a more organized src with folders and shit, and added support for compiling in linux, idk if it works", 0Dh,0Ah
